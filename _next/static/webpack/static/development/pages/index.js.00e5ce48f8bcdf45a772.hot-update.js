...
function Motivation() {
  ...
  return __jsx(_components_subject_Subject__WEBPACK_IMPORTED_MODULE_6__["Subject"], {
  ...
  }, " 6 - 8 ")), range(15).map(function (index) {
    ...
    }, index + 5), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 143,
    ...
    }, printrange(0, Math.floor((index + 5) / 4) - 1)), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 151,
    ...
    }, printrange(Math.floor((index + 5) / 4), Math.floor((index + 5) / 2) - 1)), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 159,
    ...
    }, printrange(Math.floor((index + 5) / 2), index + 5 - Math.floor((index + 5) / 4) - 1)), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 167,
    ...
    }, printrange(index + 5 - Math.floor((index + 5) / 4), index + 5)));
  })))));
}
...
//# sourceMappingURL=index.js.00e5ce48f8bcdf45a772.hot-update.js.map