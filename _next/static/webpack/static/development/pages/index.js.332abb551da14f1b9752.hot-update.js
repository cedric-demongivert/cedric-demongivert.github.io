...
function Motivation() {
  ...
  return __jsx(_components_subject_Subject__WEBPACK_IMPORTED_MODULE_6__["Subject"], {
  ...
  }, "D\xE9moralisation."), " La d\xE9moralisation est le dernier stage de la d\xE9motivation, le personnage ce voit alors sombrer peut \xE0 peut dans le d\xE9sespoir le plus absolu. Un personnage est d\xE9moralis\xE9 s'il poss\xE8de un nombre de points de volont\xE9 strictement inf\xE9rieur au quart de son score de contr\xF4le. Dans une telle situation, le personnage subit deux point de malus \xE0 l'ensemble de ses jets quels qu'ils soient."), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"], {
  ...
  }, "Motivation")), range(12).map(function (index) {
    ...
    }, "1 - ", Math.floor((index + 8) / 4) - 1), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      width: "35px",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
    ...
    }, Math.floor((index + 8) / 4), " - ", Math.floor((index + 8) / 2) - 1), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      width: "35px",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
    ...
    }, Math.floor((index + 8) / 2) - 1, " - ", index + 8 - Math.floor((index + 8) / 4) - 1), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      width: "35px",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
    ...
    }, index + 8 - Math.floor((index + 8) / 4), " - ", index + 8));
  }))));
}
...
//# sourceMappingURL=index.js.332abb551da14f1b9752.hot-update.js.map