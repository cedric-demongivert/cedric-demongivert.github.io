...
function Spell(props) {
  ...
  console.log(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(range(props.rows)).map(function (index) {
    var runes = [];
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx("div", {
    className: classnames__WEBPACK_IMPORTED_MODULE_3___default()('spell d-none d-md-flex', props.className),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 37,
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_3___default()('spell d-flex d-md-none', props.className),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 61,
...
//# sourceMappingURL=index.js.105b1cb324b91822fb58.hot-update.js.map