...
function Test() {
  ...
  }, "Perte, gain et test de volont\xE9"), __jsx(_components_subject_SubjectSummary__WEBPACK_IMPORTED_MODULE_1__["SubjectSummary"], {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17,
  ...
  }, "Test de volont\xE9."), " Plusieurs facteurs peuvent aboutir \xE0 une modification du score de volont\xE9 des personnages. La plupart d'entre eux n\xE9c\xE9ssitent de faire un test de volont\xE9 afin de savoir \xE0 quel point un individu est affect\xE9 par les \xE9v\xE8nements en cours."), __jsx("p", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28,
  ...
  }, "\xC9v\xE8nements traumatisant."), " Diff\xE9rents \xE9l\xE9ments du r\xE9cit peuvent \xEAtre traumatisant, m\xEAme pour les esprits les plus entra\xEEn\xE9s. En voici une liste non-exaustive."), __jsx("p", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 42,
  ...
  }, "Coma."), " La chute dans le coma d'un personnage c'est aussi un coup suppl\xE9mentaire ass\xE9ner \xE0 l'esprit de tous ses alli\xE9s. Quand un personnage tombe au combat l'ensemble de ses alli\xE9s doit r\xE9ussir un test de volont\xE9 d'un degr\xE9 de difficult\xE9 de 10 points. Si le test r\xE9ussi, le personnage ne perd que 2 points de volont\xE9, sinon il perd 1D4 + 1 points."), __jsx("p", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 70,
  ...
  }, "Mort."), " Le d\xE9c\xE8s d'un personnage est encore plus traumatisant encore qu'un simple coma. Quand un personnage meurt au combat l'ensemble de ses alli\xE9s doit r\xE9ussir un test de volont\xE9 d'un degr\xE9 de difficult\xE9 de 15 points. Si le test r\xE9ussi, le personnage ne perd que 2 points de volont\xE9, sinon il perd 1D6 + 1 points."), __jsx("p", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 78,
  ...
  }, "Surnombre."), " Faire face \xE0 plus d'adversaires que de raison peut amener \xE0 raisonablement penser que la partie est mal engag\xE9e. En cas de conflit, si les adversaires sont en surnombre, les joueurs doivent r\xE9aliser un test de volont\xE9 d'un degr\xE9 de difficult\xE9 \xE9quivalent au nombre d'adversaire suppl\xE9mentaire multipli\xE9 par 2. Si le test r\xE9ussi, le personnage ne perd qu'un point de volont\xE9, sinon, il en perd 1D4."), __jsx("p", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 96,
  ...
  }, "Espoir."), " L'espoir fait vivre, et plusieurs \xE9v\xE8nements peuvent amener des personnages \xE0 revoir leur estimation de survie initiale \xE0 la hausse. Prenez-garde toutefois \xE0 ne pas vous m\xE9prendre quand \xE0 la nature r\xE9elle de la lumi\xE8re observ\xE9e au bout du tunel."), __jsx("p", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 103,
  ...
  }, "Chute d'un ennemi."), " Faire tomber un adversaire")));
}

/***/ })

})
//# sourceMappingURL=index.js.3ffc7325aaec24e52ea3.hot-update.js.map