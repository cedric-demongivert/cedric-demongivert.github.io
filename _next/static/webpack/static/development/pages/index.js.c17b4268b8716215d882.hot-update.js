...
function Motivation() {
  ...
  return __jsx(_components_subject_Subject__WEBPACK_IMPORTED_MODULE_6__["Subject"], {
    ...
    }, printrange(Math.floor((index + 4) / 2), index + 8 - Math.floor((index + 8) / 4) - 1)), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 104,
    ...
    }, printrange(index + 4 - Math.floor((index + 4) / 4), index + 8)));
  })))));
}
...
//# sourceMappingURL=index.js.c17b4268b8716215d882.hot-update.js.map