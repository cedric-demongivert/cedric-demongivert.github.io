...
}, "Toutes les armures l\xE9g\xE8res voient leur malus de charge r\xE9duit de 1 point pour un minimum de 0 points.")).build()).addLevel(_feat_FeatLevel__WEBPACK_IMPORTED_MODULE_2__["FeatLevel"].builder().addRequirement(__jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, "Armures l\xE9g\xE8res 16+")).addRequirement(__jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, "Seconde peau I")).setDescription(__jsx("p", {
  __self: undefined,
  __source: {
    fileName: _jsxFileName,
    lineNumber: 32,
...
}, "Toutes les armures l\xE9g\xE8res voient leur malus de charge r\xE9duit de 2 point pour un minimum de 0 points.")).build()).build();

/***/ })

})
//# sourceMappingURL=index.js.7696a50f642c42c89810.hot-update.js.map