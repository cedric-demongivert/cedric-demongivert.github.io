...
function Motivation() {
  ...
  return __jsx(_components_subject_Subject__WEBPACK_IMPORTED_MODULE_6__["Subject"], {
    ...
    }, index + 8), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 143,
    ...
    }, printrange(0, Math.floor((index + 8) / 4) - 1)), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 151,
    ...
    }, printrange(Math.floor((index + 8) / 4), Math.floor((index + 8) / 2) - 1)), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 159,
    ...
    }, printrange(Math.floor((index + 8) / 2), index + 8 - Math.floor((index + 8) / 4) - 1)), __jsx(_components_table_Table2D__WEBPACK_IMPORTED_MODULE_7__["Table2D"].Cell, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 167,
    ...
    }, printrange(index + 8 - Math.floor((index + 8) / 4), index + 8)));
  })))));
}
...
//# sourceMappingURL=index.js.9680c9d5b7a667d5028a.hot-update.js.map