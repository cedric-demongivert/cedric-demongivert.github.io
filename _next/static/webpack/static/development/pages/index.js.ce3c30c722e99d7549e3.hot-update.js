...
function Incantation() {
  ...
  }, "Invasion."), " Vous avez invit\xE9 par m\xE9garde la mauvaise chose sur le mauvais plan, ou vous avez tout simplement attir\xE9 l'attention des mauvaises personnes. Le ma\xEEtre du jeu peut choisir une des options suivantes :", __jsx("ul", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 134,
  ...
  }, "S\xE8tm\xE9t\xE8r"), " s'invite quelques instants dans ce plan et provoque une temp\xEAte d'\xE9ther hors norme ainsi que l'apparitions d'\xE9gar\xE9s, ombres form\xE9s d'\xE9ther se nourrisant du souvenir des morts comme des vivants."), __jsx("li", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 141,
  ...
  }, "Le d\xE9voreur"), " vient chercher le magicien et l'emporter dans son plan cataclysmique. Le sol se brise et la terre tremble. Tous les personnages alentours perdent 2D10 points de volont\xE9."), __jsx("li", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 147,
  ...
  }, "Un mille-yeux"), " se fraye un chemin jusqu'aux personnages et s'appr\xE8te \xE0 festoyer d'\xE9ther et de chair fra\xEEche."))))))));
}

/***/ })

})
//# sourceMappingURL=index.js.ce3c30c722e99d7549e3.hot-update.js.map