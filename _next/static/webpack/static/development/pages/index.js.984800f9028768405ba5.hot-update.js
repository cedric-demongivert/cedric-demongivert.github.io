...
function Introduction() {
  ...
  }, "L'\xE9vocation r\xE9f\xE8re a la technique utilis\xE9e par les magiciens pour alt\xE9rer le r\xE9el par l'usage de la langue astrale. Pour lancer un sort, un magicien doit incanter les symboles qui le compose tout en se repr\xE9sentant mentalement leur forme r\xE9elle. L'\xE9vocation est un acte qui peut parra\xEEtre simple tant il ne repose que sur la capacit\xE9 d'\xE9locution et de concentration du magicien. Bien qu'incanter dans un calme relatif ne pose pas de probl\xE8me majeur \xE0 un practicien entra\xEEn\xE9, incanter tout en manageant sa propre peur et son stress dans un moment d'action o\xF9 sa propre vie est en jeu peut relever du d\xE9fis."), __jsx("p", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31,
  ...
  }, "Tout sortil\xE8ge se lance en deux \xE9tapes : une \xE9tape dite", __jsx("strong", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33,
  ...
  }, "d'\xE9vocation"), " o\xF9 le magicien doit incanter et se concentrer pour donner forme au sort, et une \xE9tape dite de", __jsx("strong", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 35,
  ...
  }, "canalisation"), " o\xF9 le magicien doit nourrir le sort en captant une quantit\xE9e d'\xE9ther suffisante dans l'espace qui l'entoure."), __jsx("p", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 39,
  ...
  }, "L'\xE9vocation d'un sortil\xE8ge peut \xEAtre subdivis\xE9 en autant d'action que n\xE9c\xE9ssaire dite action d'\xE9vocation. Lors d'une telle action, le magicien doit choisir quelle quantit\xE9e de symbole du sortil\xE8ge il souhaite incanter en une fois, la difficult\xE9e de l'incantation d\xE9pend du nombre de symboles choisi.")));
}

/***/ })

})
//# sourceMappingURL=index.js.984800f9028768405ba5.hot-update.js.map